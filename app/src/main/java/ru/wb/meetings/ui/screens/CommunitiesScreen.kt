            ...
            item{
                val avatars = listOf(
                    ...
                    Column {
                        ...
                        MainIcon(showBadge = false, isClickable = false, image = painterResource(id = R.drawable.test_avatar), showBorder = true, showClip = true, useContentScaleCrop = true)
                        EventsRow(avatars = avatars)
                        CommunityEvent(avatar = communityAvatar, title = "Designa", subTitle ="10000 человек" )
                        Spacer(modifier = Modifier.height(8.dp))
                        MeetingEvent( title = "Developer meeting", subTitle ="13.09.2024 — Москва" , isEnded = true)
                        MeetingEvent( title = "Developer meeting", subTitle ="13.09.2024 — Москва" , isEnded = false)
                        Row {
                            MainIcon(showBadge = false, isClickable = false)
